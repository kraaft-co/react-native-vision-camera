...
exports.sortFormats = exports.sortDevices = void 0;
...
const sortDevices = (left, right) => {
  ...
  const leftMaxResolution = left.formats.reduce((prev, curr) => Math.max(prev, curr.videoHeight * curr.videoWidth + curr.photoHeight * curr.photoWidth), 0);
  const rightMaxResolution = right.formats.reduce((prev, curr) => Math.max(prev, curr.videoHeight * curr.videoWidth + curr.photoHeight * curr.photoWidth), 0);
